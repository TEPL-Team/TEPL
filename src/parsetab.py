...
_lr_productions = [
  ...
  ('expression -> expression IF comp_expr','expression',3,'p_expr_if','parser.py',66),
  ...
  ('expression -> expression POWER expression','expression',3,'p_expression_binop','parser.py',77),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','parser.py',83),
  ('expression -> YES','expression',1,'p_expression_boolean','parser.py',89),
  ('expression -> NO','expression',1,'p_expression_boolean','parser.py',90),
  ('comp_expr -> expression EQ expression','comp_expr',3,'p_comp_expr','parser.py',97),
  ('comp_expr -> expression GT expression','comp_expr',3,'p_comp_expr','parser.py',98),
  ('comp_expr -> expression LT expression','comp_expr',3,'p_comp_expr','parser.py',99),
  ('comp_expr -> expression GE expression','comp_expr',3,'p_comp_expr','parser.py',100),
  ('comp_expr -> expression LE expression','comp_expr',3,'p_comp_expr','parser.py',101),
  ('comp_expr -> expression NE expression','comp_expr',3,'p_comp_expr','parser.py',102),
  ('expression -> comp_expr','expression',1,'p_expression_comp_expr','parser.py',109),
  ('expression -> NUMBER','expression',1,'p_expression_number','parser.py',115),
  ('expression -> IDENTIFIER','expression',1,'p_expression_identifier','parser.py',120),
  ('expression -> random_statement','expression',1,'p_expression_random','parser.py',125),
  ('expression -> TEXT','expression',1,'p_expression_text','parser.py',130),
  ('expression -> INPUT','expression',1,'p_expression_input','parser.py',135),
]
